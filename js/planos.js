...
const RESTAURANTE_ID = urlParams.get("restaurante_id") || null;
const PLANO_ID = urlParams.get("id_plano") || null;

// Detectar si existe conexión Supabase
const db = window.db || null;

console.log("Editor de planos iniciado");
console.log("Restaurante:", RESTAURANTE_ID);
...
async function cargarPlano() {
    ...
    if (!db) {
        console.warn("No hay conexión a la base de datos");
        return;
    }
